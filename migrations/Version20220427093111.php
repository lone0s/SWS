 ...
 */
final class Version20220427093111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE im22_User ADD COLUMN firstname VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE im22_User ADD COLUMN lastname VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E51A927B1BE1FB52 ON im22_BasketProduct (basket_id)');
        $this->addSql('CREATE INDEX IDX_E51A927B4584665A ON im22_BasketProduct (product_id)');
        $this->addSql('DROP INDEX UNIQ_9DCF7A97AA08CB10');
        $this->addSql('CREATE TEMPORARY TABLE __temp__im22_User AS SELECT id, login, roles, password FROM im22_User');
        ...
        $this->addSql('INSERT INTO im22_User (id, login, roles, password) SELECT id, login, roles, password FROM __temp__im22_User');
        $this->addSql('DROP TABLE __temp__im22_User');
